...
function UsersPage() {
  ...
  const columns = [
    ...
    { name: 'Phone', selector: row => '876-829-0344'  },
 ...
 const [loading, setLoadin] = useState(true)
  ...
  return (
    ...
    <div>
      ...
      <DataTable columns={columns} data={users} selectableRows keyField='id' title="Your Application's Users" highlightOnHover pointerOnHover pagination onRowClicked={
        (row)=> {
          console.log(row);          
          navigate(row.id)}
